...
@__app_environment_variables_v_2.5 = internal constant [37 x i8] c"0466475d-a988-4d71-a629-20505ff19935\00", align 16
...
@__ApplicationConfig_android_package_name.0 = internal constant [25 x i8] c"com.companyname.project1\00", align 16
...
@application_config = local_unnamed_addr constant %struct.ApplicationConfig {
	...
	i32 98, ; number_of_assemblies_in_apk
...
@__DSOCacheEntry_name.3 = internal constant [16 x i8] c"libSkiaSharp.so\00", align 16
@__DSOCacheEntry_name.4 = internal constant [31 x i8] c"libxamarin-debug-app-helper.so\00", align 16
@__DSOCacheEntry_name.5 = internal constant [16 x i8] c"libe_sqlite3.so\00", align 16
@__DSOCacheEntry_name.6 = internal constant [23 x i8] c"libmono-btls-shared.so\00", align 16
@__DSOCacheEntry_name.7 = internal constant [16 x i8] c"libmonodroid.so\00", align 16
@__DSOCacheEntry_name.8 = internal constant [22 x i8] c"libxa-internal-api.so\00", align 16
...
@dso_cache = local_unnamed_addr global [36 x %struct.DSOCacheEntry] [
	...
	%struct.DSOCacheEntry {
		...
		i8 0, ; ignore
		i8* getelementptr inbounds ([31 x i8], [31 x i8]* @__DSOCacheEntry_name.4, i32 0, i32 0), ; name
		i8* null; handle
	}, 
	; 4
	%struct.DSOCacheEntry {
	...
	%struct.DSOCacheEntry {
		...
		i8 0, ; ignore
		i8* getelementptr inbounds ([23 x i8], [23 x i8]* @__DSOCacheEntry_name.6, i32 0, i32 0), ; name
		i8* null; handle
	}, 
	; 6
	%struct.DSOCacheEntry {
	...
	%struct.DSOCacheEntry {
		...
		i8 0, ; ignore
		i8* getelementptr inbounds ([22 x i8], [22 x i8]* @__DSOCacheEntry_name.8, i32 0, i32 0), ; name
		i8* null; handle
	}, 
	; 14
	%struct.DSOCacheEntry {
...
@bundled_assemblies = local_unnamed_addr global [98 x %struct.XamarinAndroidBundledAssembly] [
	; 0
